...
import com.httt.backend.service.ExcelService;
import com.httt.backend.service.FilesStorageService;
import com.httt.backend.service.RoleService;
...
//        userService.createUser(user);
        userService.createUserHaveIntake(user, userService.findAllByIntakeId(new Long(1)).get(1).getIntake());
